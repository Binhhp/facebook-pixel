                    ...
                    if (response.data != null) {
                        ...
                        if (response.data.IsSuccess) {
                            if (that.state.pixelID == 0){
                                that.props.callbackSavePixelSuccess(moreAppConfig.Tab.MANAGE_PIXCEL);
                            }
                            else{
                                that.props.callbackSelectedTabChange(moreAppConfig.Tab.MANAGE_PIXCEL);
                            }
...
export default withRouter(CreatePixel);